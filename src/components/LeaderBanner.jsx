...
export default function LeaderBanner({ profiles, weighInsByUser }) {
  ...
  // Someone is leading
  return (
    <div className="rounded-2xl p-4 animate-slide-up relative overflow-hidden"
    ...
    >
      ...
      <div className="relative flex items-center gap-4">
        ...
        <div className="flex-shrink-0">
          <div className="relative">
            <div
              className="w-14 h-14 rounded-full border-2 border-cut-green/50"
              style={{
            ...
            <div className="absolute -top-1 -right-1 w-6 h-6 bg-cut-gold rounded-full flex items-center justify-center">
        ...
        <div className="flex-1 min-w-0">
          ...
          <p className="text-cut-green font-display text-xl font-black">
            by {gap.toFixed(2)}%
          </p>
