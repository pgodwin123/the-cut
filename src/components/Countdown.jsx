  ...
  return (
    <div className="card p-5 md:p-7">
      ...
      <div className="grid grid-cols-3 gap-2">
        <div className="card-inner p-2.5 md:p-5 text-center min-w-0">
          <Calendar className="w-3.5 h-3.5 text-gray-400 mx-auto mb-1" />
          <div className="font-display text-xl md:text-4xl font-bold text-white">{daysLeft}</div>
        ...
        <div className="card-inner p-2.5 md:p-5 text-center min-w-0">
          ...
          <div className="font-display text-xl md:text-4xl font-bold text-white">{currentWeek || '—'}</div>
          <div className="text-[10px] text-gray-400 truncate">{weekLabel}</div>
        </div>

        <div className="card-inner p-2.5 md:p-5 text-center min-w-0">
          <Trophy className="w-3.5 h-3.5 text-cut-gold mx-auto mb-1" />
          <div className="font-display text-xl md:text-4xl font-bold text-cut-gold">${BET_AMOUNT}</div>
